 ...
 * 
 * import com.viseo.fx.config.WebConfig; import com.viseo.fx.constant.Constants;
 * import com.viseo.fx.model.FxRate; import com.viseo.fx.model.Rates; import
 * com.viseo.fx.model.User; import com.viseo.fx.service.RatesService; import
 * com.viseo.fx.service.UserService; import org.junit.Before; import
 ...
 * 
 * import static org.hamcrest.core.Is.is; import static org.mockito.Mockito.*;
 * import static
 ...
 * 
 * @WebAppConfiguration public class RatesControllerTest {
 * 
 ...
 * //.andExpect(jsonPath("$.rates", is(ratesMap))); verify(ratesService,
 * times(1)).getLatestRates("A"); verifyNoMoreInteractions(ratesService); }
 * 
